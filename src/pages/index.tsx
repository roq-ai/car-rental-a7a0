  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Car Rental - Transforming your college project into a reality with our digital marketing platform, featuring user-friendly login, signup, and password management, all powered by MongoDB database."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1557838923-2985c318be48?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwbWFya2V0aW5nfGVufDB8fHx8MTY5NDI4MTA1NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@diggitymarketing?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Diggity Marketing`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Car Rental - Transforming your college project into a reality with our digital marketing platform, featuring user-friendly login, signup, and password management, all powered by MongoDB database.`}
            </Text>
            <Box
