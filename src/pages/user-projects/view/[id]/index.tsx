...
import { getUserProjectById } from 'apiSdk/user-projects';
import { UserProjectInterface } from 'interfaces/user-project';

function UserProjectViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('user_project', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/user-projects/edit/${id}`} passHref legacyBehavior>
                    <Button
