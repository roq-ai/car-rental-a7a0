...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': { roles: ['owner'], key: 'password-reset', tenantPath: ['organization', 'user'], userPath: [] },
  'profile.update': {
    roles: ['owner'],
    key: 'profile-update',
  ...
  'project.create': { roles: ['user'], key: 'project-creation', tenantPath: ['organization', 'project'], userPath: [] },
};
